        ...
        if (moviesData.Search) {
                ...
                <div class="card-bottom">
                    <div class="like">
                        ...
                        <i class="fa-regular fa-star ${isFav(list, element.imdbID) ? 'active' : ''} " onclick="addRemoveToFavList('${element.imdbID}')">
                        </i>
                    </div>  
                </div>
            </div>
...
function addRemoveToFavList(id) {
        ...
        if (detailsPageLikeBtn != null) {
                detailsPageLikeBtn.innerHTML = isFav(db, id) ? 'Remove From Favourites' : 'Add To Favourites';
        }
            ...
            <div class="item-details-right">
                ...
                <div class="movie-rating">
                    ...
                    <div id="like-button" onclick="addRemoveToFavList('${movieDetails.imdbID}')"> 
                        ${isFav(list, movieDetails.imdbID) ? 'Remove From Favourites' : 'Add To Favourites'} 
                    </div>
                </div>
            </div>
        </div> 
                ...
                <div class="card">
                    ...
                    <div class="card-bottom">
                        <div class="like">
                            ...
                            <i class="fa-solid fa-star ${isFav(list, element.imdbID) ? 'active' : ''} " onclick="addRemoveToFavList('${element.imdbID}')">
                            </i>              
                        </div>               
                    </div>
                </div>
